...
import { Github, Linkedin, Globe, Mail, Phone, ArrowRight, Download, Code2, Zap, Terminal } from "lucide-react";
...
function FloatingBadge({ label, icon, style }) {
  return (
    <div
      className="absolute flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-white/10 backdrop-blur-md text-xs font-semibold text-white/80 float-badge"
...
export default function Hero() {
  ...
  return (
    <>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Syne:wght@700;800;900&family=JetBrains+Mono:wght@400;600&family=DM+Sans:wght@300;400;500;600&display=swap');
        ...
        .revealed { animation: revealUp 0.7s cubic-bezier(.22,1,.36,1) forwards; }
        @keyframes revealUp {
        ...
        /* ── Floating badges ── */
        .float-badge { animation: floatBadge 4s ease-in-out infinite alternate; }
        ...
        .social-icon:hover { transform: translateY(-3px) scale(1.12); }
        ...
        .corner-tl { top: 24px; left: 24px; border-top: 2px solid rgba(99,102,241,0.5); border-left: 2px solid rgba(99,102,241,0.5); }
        .corner-br { bottom: 24px; right: 24px; border-bottom: 2px solid rgba(6,182,212,0.5); border-right: 2px solid rgba(6,182,212,0.5); }
        ...
        .orbit-ring { animation: orbit 12s linear infinite; }
        .orbit-ring-2 { animation: orbit 18s linear infinite reverse; }
      `}</style>

      <section
        className="hero-bg scanlines noise relative min-h-screen flex items-center overflow-hidden"
        style={{ fontFamily: "'DM Sans', sans-serif" }}
      >
        <ParticleCanvas />

        {/* Corner decorations */}
        <div className="corner-tl" style={{ zIndex: 3 }} />
        <div className="corner-br" style={{ zIndex: 3 }} />
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-20">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              {/* Status badge */}
              <div
                className={`reveal ${mounted ? "revealed" : ""} inline-flex items-center gap-2.5 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm mb-8`}
                style={{ animationDelay: "0.1s" }}
              >
                <span className="w-2 h-2 rounded-full bg-emerald-400 dot-pulse" />
                <span className="text-sm text-slate-300 font-medium tracking-wide" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
                  &gt; Available for hire
                </span>
              </div>

              {/* Name with glitch */}
              <div className={`reveal ${mounted ? "revealed" : ""} mb-3`} style={{ animationDelay: "0.2s" }}>
                <h1
                  data-text="SHAHID SHAH"
                  className="glitch text-6xl sm:text-7xl lg:text-8xl font-black leading-none tracking-tighter"
                  style={{
              ...
              {/* Typewriter role */}
              <div className={`reveal ${mounted ? "revealed" : ""} flex items-center gap-3 mb-6`} style={{ animationDelay: "0.35s" }}>
                <div
                  className="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-cyan-500/30"
                  style={{ background: "rgba(6,182,212,0.08)", fontFamily: "'JetBrains Mono', monospace" }}
                >
              ...
              {/* Bio */}
              <p
                className={`reveal ${mounted ? "revealed" : ""} text-slate-400 text-base leading-relaxed mb-8 max-w-lg`}
              ...
              {/* Contact row */}
              <div
                className={`reveal ${mounted ? "revealed" : ""} flex flex-wrap items-center gap-4 mb-8`}
              ...
              {/* CTA Buttons */}
              <div
                className={`reveal ${mounted ? "revealed" : ""} flex flex-wrap gap-4 mb-10`}
                style={{ animationDelay: "0.65s" }}
              >
                <MagneticBtn
                  href="#projects"
                  className="grad-btn flex items-center gap-2.5 px-7 py-3.5 rounded-xl text-sm font-bold text-white"
                ...
                <MagneticBtn
                  ...
                  download
                  className="grad-btn flex items-center gap-2.5 px-7 py-3.5 rounded-xl text-sm font-bold text-white border border-white/10"
              ...
              {/* Social links */}
              <div
                className={`reveal ${mounted ? "revealed" : ""} flex items-center gap-4`}
              ...
              >
                ...
                <div className="flex gap-3">
                  {[
                    ...
                    { icon: <Linkedin className="w-4 h-4" />, label: "LinkedIn", href: "https://www.linkedin.com/in/shahid-shah-416b3b198/?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BJoLBTukHRaW6pr11nw72uA%3D%3D", color: "#06b6d4" },
                    { icon: <Globe className="w-4 h-4" />,    label: "Portfolio",href: "https://www.linkedin.com/safety/go/?url=https%3A%2F%2Fmy-portfolio-one-xi-46.vercel.app%2F&urlhash=comv&isSdui=true&lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BJoLBTukHRaW6pr11nw72uA%3D%3D", color: "#10b981" },
                  ].map((s, i) => (
                    <a
                      key={i} href={s.href} target="_blank" rel="noopener noreferrer"
                      className="social-icon flex items-center gap-1.5 px-3.5 py-2 rounded-lg border border-white/10 text-xs font-semibold text-slate-300"
            ...
            {/* ── RIGHT COLUMN — 3D floating image ── */}
            <div className={`reveal ${mounted ? "revealed" : ""} relative flex items-center justify-center`} style={{ animationDelay: "0.3s" }}>
              ...
              {/* Orbit rings */}
              <div className="absolute w-[320px] h-[320px] rounded-full pointer-events-none orbit-ring"
                style={{ border: "1px dashed rgba(99,102,241,0.25)" }} />
              <div className="absolute w-[400px] h-[400px] rounded-full pointer-events-none orbit-ring-2"
                style={{ border: "1px dashed rgba(6,182,212,0.15)" }} />

              {/* Glow rings */}
              <div className="absolute w-[270px] h-[270px] rounded-full ring-pulse pointer-events-none"
                style={{ border: "2px solid rgba(99,102,241,0.4)", boxShadow: "0 0 40px rgba(99,102,241,0.2)" }} />
              <div className="absolute w-[290px] h-[290px] rounded-full ring-pulse-2 pointer-events-none"
                style={{ border: "1px solid rgba(6,182,212,0.3)" }} />
              <div className="absolute w-[310px] h-[310px] rounded-full ring-pulse-3 pointer-events-none"
                ...
                {/* <img
                  ...
                  onError={(e) => {
                    ...
                    e.currentTarget.parentElement.style.background =
                      "linear-gradient(135deg, rgba(99,102,241,0.3) 0%, rgba(6,182,212,0.2) 50%, rgba(244,114,182,0.2) 100%)";
                  }}
                /> */}
              ...
              <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 flex gap-3">
                {[
                  ...
                  <div
                    key={i}
                    className="text-center px-4 py-2 rounded-xl border border-white/10 backdrop-blur-md"
                    style={{
          ...
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-40">
            ...
            <div className="w-px h-8 bg-gradient-to-b from-indigo-400 to-transparent" style={{ animation: "revealUp 1.5s ease-in-out infinite" }} />
          </div>
        </div>
      </section>
    </>
